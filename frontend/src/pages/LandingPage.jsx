...
import heroImg from "../assets/intervew-table.png";
  ...
  return (
    <>
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2">
              <p className="text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                ...
                prrparation to mastery -- your ultimate interview toolkit here.
              </p>
              <button
        ...
        <div>
          <section className="flex items-center justify-center -mt-36">
            <img
              src={heroImg}
              alt="image"
              className="w-[80vw] rounded-lg border border-amber-100"
            />
          </section>
        </div>
      </div>
      ...
      <div className="w-full min-h-full bg-[#FFFCEF] mt-10">
          ...
          <section className="mt-5">
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ">
                {APP_FEATURES.slice(6).map((feature) => (
                  <div
                    key={feature.id}
                    className="bg-[#FFFEFB] p-6 rounded-xl shadow-xs hover:shadow-lg shadow-amber-100 transition border border-amber-100"
                  >
        ...
        <div className="text-sm bg-gary-50 text-secondary text-center p-5 mt-5">
