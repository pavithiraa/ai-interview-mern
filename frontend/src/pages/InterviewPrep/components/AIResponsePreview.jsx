          ...
          components={{
            p({ node, children }) {
              if (
                ...
                return <>{children}</>; // Prevent <p> wrapping <pre>
              }
            ...
            ol({ children }) {
              return (
                <ol className="list demical pl-6 space-y-2 my-4 ">
                  {children}
                </ol>
              );
            },
            ...
            td({ children }) {
              return (
                <th className="px-3 py-2 whitespace-nowrap text-sm">
                  {children}
                </th>
              );
            },
    ...
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        >
          ...
          {copied && (
            <span className="absolute -top-8 right-0 bg-black text-white text-xs rounded-md pz-2 py-1 opacity-80 group-hover:opacity-100 transition">
              Copied!
            </span>
          )}
        </button>
