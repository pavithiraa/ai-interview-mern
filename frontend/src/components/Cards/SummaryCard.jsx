...
const SummaryCard = ({
  ...
  return (
    <div
      className="bg-white border border-gray-300/30 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group"
      onClick={onSelect}
    >
      <div
      ...
      <div className="px-3 pb-3">
        <div className="flex items-center gap-3 mt-4">
          <div className="text-[10px] font-medium text-black px-3 py-1 border-[0.5px] borde-gray-900 rounded-full">
